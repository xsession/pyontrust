...
for iDevice in range(0, cDevice.value):
    ...
    if int0.value != 0:
        dwf.FDwfDigitalOutDividerInfo(hdwf, 0, None, byref(uint0))
        dwf.FDwfDigitalOutCounterInfo(hdwf, 0, None, byref(uint1))
        print("Max divider: "+str(uint0.value)+" counter: "+str(uint1.value))
