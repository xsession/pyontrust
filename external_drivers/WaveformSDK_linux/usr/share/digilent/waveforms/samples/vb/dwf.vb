...
Module dwf
    ...
    Public Const devidADP5470 As Integer      = 11
    Public Const devidADP5490 As Integer      = 12
    Public Const devidADP2230 As Integer      = 14
    ...
    Public Const trigsrcClock As Byte                = 17
    ...
    Public Const DwfStateNotDone As Byte        = 6
    ...
    Public Const filterAverageFit As Integer = 3
    ...
    Public Const funcSineNA As Byte = 10
    Public Const funcCustomPattern As Byte = 28
    Public Const funcPlayPattern As Byte = 29
    Public Const funcCustom As Byte = 30
    Public Const funcPlay As Byte = 31

    Public Const funcAnalogIn1 As Byte = 64
    Public Const funcAnalogIn2 As Byte = 65
    Public Const funcAnalogIn3 As Byte = 66
    Public Const funcAnalogIn4 As Byte = 67
    Public Const funcAnalogIn5 As Byte = 68
    Public Const funcAnalogIn6 As Byte = 69
    Public Const funcAnalogIn7 As Byte = 70
    Public Const funcAnalogIn8 As Byte = 71
    Public Const funcAnalogIn9 As Byte = 72
    Public Const funcAnalogIn10 As Byte = 73
    Public Const funcAnalogIn11 As Byte = 74
    Public Const funcAnalogIn12 As Byte = 75
    Public Const funcAnalogIn13 As Byte = 76
    Public Const funcAnalogIn14 As Byte = 77
    Public Const funcAnalogIn15 As Byte = 78
    Public Const funcAnalogIn16 As Byte = 79
    ...
    Public Const analogioSlew As Byte = 12

    Public Const DwfDmmResistance As Integer = 1
    Public Const DwfDmmContinuity As Integer = 2
    Public Const DwfDmmDiode As Integer = 3
    Public Const DwfDmmDCVoltage As Integer = 4
    Public Const DwfDmmACVoltage As Integer = 5
    Public Const DwfDmmDCCurrent As Integer = 6
    Public Const DwfDmmACCurrent As Integer = 7
    Public Const DwfDmmDCLowCurrent As Integer = 8
    Public Const DwfDmmACLowCurrent As Integer = 9
    Public Const DwfDmmTemperature As Integer = 10
    ...
    Public Const DwfAnalogOutIdleHold As Integer = 3
    ...
    Public Const DwfDigitalOutTypeState As Integer = 4
    Public Const DwfDigitalOutTypePlay As Integer = 5
    ...
    Public Const DwfParamTempLimit As Integer  = 11
    Public Const DwfParamFreqPhase As Integer  = 12
    Public Const DwfParamDigitalVoltage As Integer  = 13 ' mV
    Public Const DwfParamFreqPhaseSteps As Integer  = 14 ' read-only
